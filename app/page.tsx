          ...
          {HERO_TRIO.map((id, i) => {
            ...
            return (
              <button
                ...
                className="animate-float relative -mx-8 block w-2/5 overflow-hidden rounded-2xl border border-hood/40 shadow-[0_20px_60px_rgba(210,255,3,0.3)] transition-transform hover:z-10 hover:scale-110"
                style={{
                  "--tilt": `${(i - 1) * 8}deg`,
                  zIndex: i === 1 ? 5 : 1,
